...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-slate-900/80 backdrop-blur-sm border-t border-white/10 py-12 px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Enterprise-grade voice AI for modern businesses. Built with Pipecat.ai and WebRTC.
            </p>
          </div>
